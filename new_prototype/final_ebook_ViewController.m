    ...
    NSURLSessionDownloadTask * downloadTask =[ defaultSession downloadTaskWithURL:url
                                                                completionHandler:^(NSURL *location, NSURLResponse *response, NSError *error)
                                              {
                                                  if(error == nil)
                                                  {
                                                      ...
                                                      NSURL *docsDirURL = [NSURL fileURLWithPath:[docsDir stringByAppendingPathComponent:@"final5.epub"]];
                                                      NSString *docPath =[docsDir stringByAppendingPathComponent:@"final5.epub"];
                                                                               ...
                                                                               error: &err])
                                                      {
                                                          ...
                                                          NSString *filePath = [NSString stringWithFormat:@"%@/final5.epub",docPath];
